  ...
  render() {
    return (
      <div id="tags">
        ...
        <div className="animated bounceInRight chip" id="chip2">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip3">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip4">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip5">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip6">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip7">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip8">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip9">
          <img
        ...
        <div className="animated bounceInRight chip" id="chip10">
          <img
